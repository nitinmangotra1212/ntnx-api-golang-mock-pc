/*
 * Generated file models/nexus/v4/error/error_model.go.
 *
...
func NewAppMessage() *AppMessage {
  ...
  *p.ObjectType_ = "nexus.v4.error.AppMessage"
...
func NewErrorResponse() *ErrorResponse {
  p := new(ErrorResponse)
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "nexus.v4.error.ErrorResponse"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "nexus.v4.error.SchemaValidationError"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "nexus.v4.error.SchemaValidationErrorMessage"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
