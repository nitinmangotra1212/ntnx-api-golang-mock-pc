/*
 * Generated file models/mock/v4/error/error_model.go.
 *
...
func NewAppMessage() *AppMessage {
  ...
  *p.ObjectType_ = "mock.v4.error.AppMessage"
...
func NewErrorResponse() *ErrorResponse {
  p := new(ErrorResponse)
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "mock.v4.error.ErrorResponse"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationError() *SchemaValidationError {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "mock.v4.error.SchemaValidationError"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
...
func NewSchemaValidationErrorMessage() *SchemaValidationErrorMessage {
  ...
  p.ObjectType_ = new(string)
  *p.ObjectType_ = "mock.v4.error.SchemaValidationErrorMessage"
  p.Reserved_ = map[string]interface{}{"$fv": "v4.r1"}
  p.UnknownFields_ = map[string]interface{}{}
...
func (p *OneOfErrorResponseError) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    ...
    case []AppMessage:
      ...
      if nil == p.Discriminator {p.Discriminator = new(string)}
      *p.Discriminator = "List<mock.v4.error.AppMessage>"
      if nil == p.ObjectType_ {p.ObjectType_ = new(string)}
      *p.ObjectType_ = "List<mock.v4.error.AppMessage>"
    default:
...
func (p *OneOfErrorResponseError) GetValue() interface{} {
  ...
  if "List<mock.v4.error.AppMessage>" == *p.Discriminator {
...
func (p *OneOfErrorResponseError) UnmarshalJSON(b []byte) error {
  ...
  if err := json.Unmarshal(b, vOneOfType202); err == nil {
    if "mock.v4.error.SchemaValidationError" == *vOneOfType202.ObjectType_ {
      if nil == p.oneOfType202 {p.oneOfType202 = new(SchemaValidationError)}
  ...
  if err := json.Unmarshal(b, vOneOfType201); err == nil {
    if len(*vOneOfType201) == 0 || "mock.v4.error.AppMessage" == *((*vOneOfType201)[0].ObjectType_) {
