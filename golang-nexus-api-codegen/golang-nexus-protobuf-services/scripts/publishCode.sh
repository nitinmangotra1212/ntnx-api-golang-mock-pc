...
PROTO_SERVICES_PATH=$API_SERVER_SOURCE_PATH/protobuf/swagger
...
if command -v protoc-gen-go &> /dev/null; then
    ...
    if find "." -type f -name "*service*pb.go" | grep -q .; then
        ...
        echo "⚠️  Warning: No Go service files found (may be generated later)"
    fi
else
...
export new_path_common="github.com/nutanix/ntnx-api-golang-nexus-pc/generated-code/protobuf/common/"
