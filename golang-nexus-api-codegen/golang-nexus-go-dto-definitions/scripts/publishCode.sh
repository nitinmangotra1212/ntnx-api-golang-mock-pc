...
export new_path="github.com/nutanix/ntnx-api-golang-nexus-pc/generated-code/dto/models/"
...
do
    if [[ -f "$file" ]]; then
        ...
        # Fix import paths: models/... -> github.com/nutanix/ntnx-api-golang-nexus-pc/generated-code/dto/models/...
        ...
        if grep -q '"models/' "$file"; then
            sed -i '' 's|"models/|"github.com/nutanix/ntnx-api-golang-nexus-pc/generated-code/dto/models/|g' "$file"
        fi
    fi
done
echo "Done"
